...
export default function YogaPlan() {
  return (
    <div>
        <section className='container text-pink-50 sm:h-screen sm:mt-14 xs:flex xs:flex-col xs:items-center xs:text-center sm:px-16 lg:flex-row lg:text-left lg:gap-10 lg:h-[95vh]' style={{ backgroundImage: `url(${process.env.PUBLIC_URL + '/yoga-laptop.png'})`,
            backgroundRepeat: 'no-repeat',
            marginTop: '50px',
            backgroundPositionY: 'center',
            backgroundPositionX: 'center'}}>
            <div className='xs:flex xs:flex-col sm:h-60 lg:w-[55vw]'>
                <h1 className='pl-2 text-[34px] font-bold lg:flex lg:items-center lg:border-l-2'>Classes
                <span className="b-text text-[15px] font-medium tracking-widest sm:hidden xs:block lg:block lg:mt-3"> &nbsp; Select your yoga plan</span> </h1>
                <p className='mt-2 font-light xl:mb-0 lg:mb-5 md:mb-5 sm:mb-3 text-gray-300 leading-tight xs:hidden sm:block'>
            ...
            <div className='flex flex-col gap-10 xs:mt-3'>
